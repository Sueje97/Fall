...
# 预测类别和概率
    ...
    shap.force_plot(shap_values[0], pd.DataFrame([features.iloc[0]], columns=features.columns), matplotlib=True,figsize=(30, 3))
    plt.savefig("shap_force_plot.png",  dpi=500)
